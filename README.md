...
- [STEP1: 静的なTodoリストの作成](step1.md)
- [STEP2: 動的なデータ構造へのリファクタリング](step2.md)
- [STEP3: Todoの完了状態をチェックボックスで切り替え](step3.md)
- STEP4: Todoの追加機能の実装
  - [STEP4-1: 新しいタスクの追加](step4-1.md)
  - [STEP4-2: ルーン($state)の導入](step4-2.md)
  - [STEP4-3: 新しいタスクの追加機能の強化](step4-3.md)
- [STEP5: タスクの削除](step5.md)
- [STEP6: データの永続化](step6.md)
- STEP7: デザインの強化
  - [STEP7-1: tailwindcssのインストール](step7-1.md)
  - [STEP7-2: tailwindcssの実装](step7-2.md)
- [STEP8: デプロイ](step8.md)
